...
// we are going to instantiate this with a given cateogry
// and fetch the associated playlists
...
class CategoryViewController: UIViewController{
    ...
    private let collectionView = UICollectionView(frame: .zero, collectionViewLayout:
                                                    UICollectionViewCompositionalLayout(sectionProvider: { _, _ -> NSCollectionLayoutSection? in
                                                        ...
                                                        // insert content insents between our items
...
extension CategoryViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        // first need to get the playlist out for the given cell
